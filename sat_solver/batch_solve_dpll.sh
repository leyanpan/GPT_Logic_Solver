...
for pair in "${min_max_pairs[@]}"; do
    ...
    for option in "${options[@]}"; do
        ...
        python solve_trace.py datasets/SAT_${min_n}_${max_n}_${suffix}.txt outputs/SAT_${min_n}_${max_n}_${suffix}.txt -t dpll
        
        # Generate the command for the test dataset
        python solve_trace.py datasets/SAT_${min_n}_${max_n}_${suffix}_Test.txt outputs/SAT_${min_n}_${max_n}_${suffix}_Test.txt -t dpll
    done
done
