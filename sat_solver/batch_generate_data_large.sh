...
for pair in "${min_max_pairs[@]}"; do
    ...
    for option in "${options[@]}"; do
        ...
        python generate_formula.py 500000 datasets/SAT_${min_n}_${max_n}_${suffix}_large.txt --min_n ${min_n} --max_n ${max_n} ${option}
        python solve_trace.py datasets/SAT_${min_n}_${max_n}_${suffix}_large.txt outputs/SAT_${min_n}_${max_n}_${suffix}_large.txt -t state -m random
