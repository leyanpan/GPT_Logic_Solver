...
if __name__ == "__main__":
    ...
    # test a bunch
    correct_pred, correct_sat, correct_unsat, all_correct, total_sat, total_unsat, total = verify_traces([example_line_sat, example_line_unsat, example_incorrect_trace, example_incorrect_trace_2])
